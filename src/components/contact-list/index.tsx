...
import { FaGithubSquare, FaYoutubeSquare, FaLinkedin } from 'react-icons/fa'
  ...
  return (
    <Box display="flex" justifyContent="center" alignItems="center" gap="4">
      <Link
        ...
        target="_blank"
      >
        <Icon as={FaSquareTwitter} color={titleColor} boxSize={[6, 8, 10]} />
      </Link>
      ...
      <Link
        ...
        target="_blank"
      >
        <Icon as={FaGithubSquare} color={titleColor} boxSize={[6, 8, 10]} />
      </Link>
      ...
      <Link
        ...
        target="_blank"
      >
        <Icon as={FaYoutubeSquare} color={titleColor} boxSize={[6, 8, 10]} />
      </Link>
      ...
      <Link
        ...
        target="_blank"
      >
        <Icon as={FaLinkedin} color={titleColor} boxSize={[6, 8, 10]} />
      </Link>
    </Box>
  )
}
